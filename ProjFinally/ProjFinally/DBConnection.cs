...
namespace ProjFinally
{
    public class DBConnection
    {
        ...
        {
            string connString = @"Data Source=DAOTIEN\DAOTIEN" + ";Initial Catalog=QuanLyCuaHangMyPham"
        ...
        public DBConnection()
        {
            conStr = "Data Source=DAOTIEN\\DAOTIEN;Initial Catalog=QuanLyCuaHangMyPham;Integrated Security=True";
